...
public class Cache {
    /**
     * @Classname : Cache
     * @Description : the cache of block
     **/
    HashMap<CacheKey, BlockIO> blockHashMap;                                        //the storage of block in memory
    Database database;
    ...
    /**
     * @Description : insert row into the block
    ...
    **/
    ...
    /**
     * @Description : get the row by the block and row index
    ...
    **/
    ...
    /**
     * @Description : get a block from the cache key,if the block is not in memory, then it will be loaded
    ...
    **/
    ...
    /**
     * @Description : put a block into the cache
    ...
    **/
    ...
    /**
     * @Description : remove a block from the cache
    **/
