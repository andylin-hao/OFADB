...
/**
 * Record of the difference between index in memory and index data
 **/
...
//        deleteList = new ArrayList<NodeIndex>();
    ...
    /**
     * Get a offset in file for the node
     **/
    ...
    /**
     * Remove tha node from the update list and put the space into empty list
     **/
    ...
    /**
     * Put all the change into file,write the empty list first,then rewrite all the node in update list
     **/
