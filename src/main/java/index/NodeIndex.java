...
public class NodeIndex implements NodeBPlus {
    /**
     * @Classname : NodeIndex
     * @Description : node of index tree
     **/
    ...
    /**
     * @Description : get the offset of previous node
    **/
    ...
    /**
     * @Description : get the offset of next node
     **/
    ...
    /**
     * @Description : get the next node having the same parent node
    **/
    @Override
    ...
    /**
     * @Description : get the previous node having the same parent
    **/
    @Override
    ...
    /**
     * @Description : get the node leaf of input key
    **/
    @Override
    ...
    /**
     * @Description : add a new key  into a leaf node
    **/
    @Override
    ...
    /**
     * @Description : insert row into index
     * @param data : row info
    ...
    **/
    ...
    /**
     * @Description : from the current node recursively upwards the tree
    **/
    @Override
    ...
    /**
     * @Description : find one key is stored in the tree or not.if exits ,return the its index in leaf node,or return -1;
    **/
    @Override
    ...
    /**
     * @Description : cut connect with other things
    **/
    @Override
    public void cutLink(){
        setParent(null);
    ...
    /**
     * @Description : delete one key from a leaf node
    **/
    @Override
    ...
    /**
     * @Description : remove one row info from the node leaf having key
    **/
    @Override
