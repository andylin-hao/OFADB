...
/**
 * The methods to load rowData from bytes and write rowData to Bytes.
 **/
...
public class RowIO {
    ...
    /**
     * Get the BitMap of null value from the data bytes, 0 = null
     *
     * @param types      : the array of column types
    ...
    /**
     * Set data of column which has 0 in null Bitmap to null
     *
     * @param data       : the bytes arrays
    ...
    /**
     * Load the data of column which has variable length from bytes
     *
     * @param types      : the array of column types
     * @param data       : the bytes arrays
     * @param dataLoader : the input stream with the data bytes as buffer
    ...
    /**
     * Load the data of column which has fixed length from bytes* @param types : the array of column types
     *
     * @param types      : the array of column types
     * @param data       : the bytes arrays
     * @param dataLoader : the input stream with the data bytes as buffer
    ...
    /**
     * Write the null BitMap to bytes,0 = null
     *
     * @param data  : array of object data
     * @param types : type array
     **/
    ...
    /**
     * Write the entry of (offset,length) for the variable column
     *
