...
public interface SQLiteVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#update_values_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUpdate_values_stmt(SQLiteParser.Update_values_stmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#where_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhere_clause(SQLiteParser.Where_clauseContext ctx);
	/**
